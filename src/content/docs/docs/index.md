...
Every App Fair app is built around the [Four Cornerstones](/docs/philosophy/#four-cornerstones): **Transparent** (free and open source), **Ubiquitous** (every mobile platform), **Global** (every language), and **Accessible** (every ability). See [Philosophy](/docs/philosophy/) for the full discussion.
...
- **[Philosophy](/docs/philosophy/)**: the principles behind the project and the Four Cornerstones every catalog app rests on.
...
- **[Deployment & Distribution](/docs/deploying/)**: how the `appfair/` fork builds, signs, and distributes the app to the stores and the catalog.
- **[Maintaining Your App](/docs/maintenance/)**: updates, translations, and project handoff.
- **[FAQ](/docs/faq/)**: frequently asked questions.
- **[Glossary](/docs/glossary/)**: recurring terms used throughout the docs.
